...
def main():
    ...
    with importlib.resources.open_text(
        ...
        zmanim_bool, location_str, geonames_key, shabbat = read_config(
            default_config_file, user_config_file
        )

    if geonames_key is None:
        print(
            "It looks like you haven't included a geonames_key in your config.yaml file. If you need a geonames API key, you can create an account at https://www.geonames.org/login"
        )
        sys.exit(1)
